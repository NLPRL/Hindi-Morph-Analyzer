import pickle
from load_data_with_phonetic_two import load_data_for_seq2seq, load_data_for_features
...
if MODE == 'train':
	...
	hist = model.fit([X_train[:500], X_decoder_input[:500],  X_right1_tr[:500], X_right2_tr[:500], X_right3_tr[:500], X_right4_tr[:500], X_left1_tr[:500], X_left2_tr[:500], X_left3_tr[:500], X_left4_tr[:500], X_train_phonetics[:500]],
				 [y_sequences_tr[:500], y1_tr[:500], y2_tr[:500], y3_tr[:500], y4_tr[:500], y5_tr[:500], y7_tr[:500]],
				 validation_data=([X_val[:100], X_decoder_val[:100],  X_right1_val[:100], X_right2_val[:100], X_right3_val[:100], X_right4_val[:100], X_left1_val[:100], X_left2_val[:100], X_left3_val[:100], X_left4_val[:100], X_val_phonetics[:100]],\
				 [y_sequences_val[:100], y1_val[:100], y2_val[:100], y3_val[:100], y4_val[:100], y5_val[:100], y7_val[:100]]),
	...
	hist = pseudo_model.fit([X_train[:500], X_decoder_input[:500],  X_right1_tr[:500], X_right2_tr[:500], X_right3_tr[:500], X_right4_tr[:500], X_left1_tr[:500], X_left2_tr[:500], X_left3_tr[:500], X_left4_tr[:500], X_train_phonetics[:500]],
				 [y_sequences_tr[:500], y1_tr[:500], y2_tr[:500], y3_tr[:500], y4_tr[:500], y5_tr[:500], y7_tr[:500]],
				 validation_data=([X_val[:100], X_decoder_val[:100],  X_right1_val[:100], X_right2_val[:100], X_right3_val[:100], X_right4_val[:100], X_left1_val[:100], X_left2_val[:100], X_left3_val[:100], X_left4_val[:100], X_val_phonetics[:100]],\
				 [y_sequences_val[:100], y1_val[:100], y2_val[:100], y3_val[:100], y4_val[:100], y5_val[:100], y7_val[:100]]),
